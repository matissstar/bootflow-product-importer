...
class Bfpi_Deactivator {
    ...
    public static function uninstall() {
        ...
        $wpdb->query("DROP TABLE IF EXISTS {$wpdb->prefix}bfpi_imports");
        $wpdb->query("DROP TABLE IF EXISTS {$wpdb->prefix}bfpi_import_logs");
        ...
        // Remove user meta
        $wpdb->query("DELETE FROM {$wpdb->usermeta} WHERE meta_key LIKE 'bfpi_%'");
