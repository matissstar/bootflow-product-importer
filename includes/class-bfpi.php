...
class Bfpi {
    ...
    private function define_admin_hooks() {
        ...
        $this->loader->add_action('wp_ajax_bfpi_test_url', $plugin_admin, 'handle_test_url');
        $this->loader->add_action('wp_ajax_bfpi_test_ai', $plugin_admin, 'handle_test_ai');
        $this->loader->add_action('wp_ajax_bfpi_test_php', $plugin_admin, 'handle_test_php');
        $this->loader->add_action('wp_ajax_bfpi_test_shipping', $plugin_admin, 'handle_test_shipping');
        $this->loader->add_action('wp_ajax_bfpi_save_mapping', $plugin_admin, 'handle_save_mapping');
        
        // AI Auto-Mapping (ADVANCED tier)
        $this->loader->add_action('wp_ajax_bfpi_auto_mapping', $plugin_admin, 'handle_ai_auto_mapping');
        ...
        $this->loader->add_action('wp_ajax_bfpi_save_recipe', $plugin_admin, 'ajax_save_recipe');
        $this->loader->add_action('wp_ajax_bfpi_load_recipe', $plugin_admin, 'ajax_load_recipe');
        $this->loader->add_action('wp_ajax_bfpi_delete_recipe', $plugin_admin, 'ajax_delete_recipe');
        $this->loader->add_action('wp_ajax_bfpi_get_recipes', $plugin_admin, 'ajax_get_recipes');
        ...
        // Language switcher
        $this->loader->add_action('wp_ajax_bootflow_switch_language', 'Bfpi_i18n', 'ajax_switch_language');
        ...
        $this->loader->add_action('wp_ajax_nopriv_bfpi_process_batch', $plugin_admin, 'handle_process_batch');
        
        // Cron endpoint - no priv needed, uses secret key
        $this->loader->add_action('wp_ajax_nopriv_bfpi_cron', $plugin_admin, 'handle_cron_import');
        $this->loader->add_action('wp_ajax_bfpi_cron', $plugin_admin, 'handle_cron_import');
        
        // Individual import cron endpoint
        $this->loader->add_action('wp_ajax_nopriv_bfpi_single_cron', $plugin_admin, 'handle_single_import_cron');
        $this->loader->add_action('wp_ajax_bfpi_single_cron', $plugin_admin, 'handle_single_import_cron');
    }
